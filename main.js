...
const getweather_state = o => o.weather_state_name;
const sortByweather_state = sortBy(getweather_state);

weather.sort(sortByweather_state);
console.log(weather.map(getweather_state)); weatherA.concat(weatherB))
...
const idealTemp = o => o.min_temp;
const sortByidealTemp = sortBy(getidealTemp);

weather.sort(sortByidealTemp);
console.log(weather.map(getidealTemp));
